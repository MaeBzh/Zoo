                            ...
                            <table class="table">
                                ...
                                <?php foreach ($especes as $espece) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo URL ?>animaux/formulaire_edition_espece?id=<?php echo $espece->id ?>"
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-warning btn-lg" data-toggle="modal"
                                                    data-target="#zone_<?php echo $espece->id ?>">
                                                <i class="fa fa-times"></i>
                                            </button>

                                            <div id="zone_<?php echo $espece->id ?>" class="modal fade" tabindex="-1"
                                                 role="dialog">
                                                    ...
                                                    <div class="modal-content">
                                                        <form role="form" method="POST"
                                                            ...
                                                            <div class="modal-header">
                                                                ...
                                                                <h4 class="modal-title">Suppression de la fiche espèce</h4>
                                                            </div>
                                                            <div class="modal-body">
                                                                <input type="hidden" name="id"
                                                                       value="<?php echo $espece->id ?>">
                                                                <p>Etes-vous sûr de vouloir supprimer la
                                                                    fiche <?php echo $espece->nom_vulgaire ?> ?</p>
                                                            </div>
