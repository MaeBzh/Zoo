            ...
            <div class="col-md-12">
                <div class="box box-warning">
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-cutlery"></i> Ajout d'une fiche repas pour la zone <?php echo $zone->designation; ?></h3>
                    </div>
                    <form role="form" method="post" action="<?php echo URL ?>repas/post_formulaire_ajout">
                        <div class="box-body">
                            ...
                            <div class="form-group col-md-5">
                                ...
                                <input type="number" class="form-control" name="designation[]" required>
                            </div>
