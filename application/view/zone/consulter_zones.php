                            ...
                            <table class="table">
                                ...
                                <?php foreach ($zones as $zone) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo URL ?>zone/formulaire_edition?id=<?php echo $zone->id ?>" class="btn btn-warning btn-lg">
                                        ...
                                        <td>
                                            ...
                                            <div id="zone_<?php echo $zone->id ?>" class="modal fade" tabindex="-1" role="dialog">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <form role="form" method="POST" action="<?php echo URL ?>zone/post_formulaire_suppression">
